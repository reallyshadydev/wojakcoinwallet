...
export function ReceiveView() {
  ...
  return (
    <div className="mx-auto max-w-lg">
      <div className="mb-6">
        <h2 className="text-xl font-bold text-foreground">Receive WojakCoin</h2>
      ...
      <Card>
        <CardContent className="flex flex-col items-center gap-6 p-6">
          ...
          <div className="flex w-full flex-col gap-2">
            <Label className="text-xs font-medium text-muted-foreground">Your Address</Label>
            ...
            <p className="text-[10px] text-muted-foreground">
              Legacy (P2PKH) address. Only send WojakCoin (WJK) to this address.
            </p>
          </div>
